...
import { ExtractDateTypeFromSelection, DateSelectionModel, DateSelectionModelChange } from './date-selection-model';
 ...
 */
export declare class DatepickerInputEvent<D, S = unknown> {
...
export declare abstract class DatepickerInputBase<S, D = ExtractDateTypeFromSelection<S>> implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy, Validator {
    ...
    constructor(_elementRef: ElementRef<HTMLInputElement>, _dateAdapter: DateAdapter<D>, _dateFormats: DateFormats);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DatepickerInputBase<any, any>, [null, { optional: true; }, { optional: true; }]>;
