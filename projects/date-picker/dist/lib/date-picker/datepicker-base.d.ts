...
import { ElementRef, EventEmitter, InjectionToken, NgZone, OnDestroy, ViewContainerRef, OnChanges, SimpleChanges } from '@angular/core';
...
import { ExtractDateTypeFromSelection, DateSelectionModel } from './date-selection-model';
...
export interface DatepickerPanel<C extends DatepickerControl<D>, S, D = ExtractDateTypeFromSelection<S>> {
...
export declare abstract class DatepickerBase<C extends DatepickerControl<D>, S, D = ExtractDateTypeFromSelection<S>> implements DatepickerPanel<C, S, D>, OnDestroy, OnChanges {
    private _overlay;
    private _ngZone;
    ...
    constructor(_overlay: Overlay, _ngZone: NgZone, _viewContainerRef: ViewContainerRef, scrollStrategy: any, _dateAdapter: DateAdapter<D>, _dir: Directionality, _model: DateSelectionModel<S, D>);
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<DatepickerBase<any, any, any>, [null, null, null, null, { optional: true; }, { optional: true; }, null]>;
