 ...
 */
import { ErrorHandler, OnDestroy, Optional } from '@angular/core';
 ...
 * @docs-private
 */
export declare function getSvgIconNameNotFoundError(iconName: string): Error;
/**
 * Returns an exception to be thrown when the consumer attempts to use
 * `<svg-icon>` without including @angular/common/http.
 * @docs-private
 */
export declare function getSvgIconNoHttpProviderError(): Error;
/**
 ...
 * @docs-private
 */
export declare function getSvgIconFailedToSanitizeLiteralError(literal: SafeHtml): Error;
 ...
 */
export declare class SvgIconRegistry implements OnDestroy {
    private _httpClient;
    private _sanitizer;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<SvgIconRegistry, [{ optional: true; }, null, { optional: true; }, null]>;
    static ɵprov: i0.ɵɵInjectableDeclaration<SvgIconRegistry>;
}
/** @docs-private */
export declare function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry: SvgIconRegistry, httpClient: HttpClient, sanitizer: DomSanitizer, errorHandler: ErrorHandler, document?: any): SvgIconRegistry;
/** @docs-private */
