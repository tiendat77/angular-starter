...
class SvgIcon {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.8", ngImport: i0, type: SvgIcon, deps: [{ token: i0.ElementRef }, { token: SvgIconRegistry }, { token: i0.ErrorHandler }, { token: 'aria-hidden', attribute: true }, { token: SVG_ICON_LOCATION }], target: i0.ɵɵFactoryTarget.Component });
 ...
 */
class SvgIconModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.8", ngImport: i0, type: SvgIconModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.8", ngImport: i0, type: SvgIconModule, imports: [SvgIcon], exports: [SvgIcon] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "18.2.8", ngImport: i0, type: SvgIconModule });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.8", ngImport: i0, type: SvgIconModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [SvgIcon],
                    exports: [SvgIcon],
