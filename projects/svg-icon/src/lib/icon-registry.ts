 ...
 * @docs-private
 */
export function getSvgIconNameNotFoundError(iconName: string): Error {
 ...
 * @docs-private
 */
export function getSvgIconNoHttpProviderError(): Error {
  return Error(
    'Could not find HttpClient provider for use with Angular Svg icons. ' +
 ...
 * @docs-private
 */
export function getSvgIconFailedToSanitizeLiteralError(literal: SafeHtml): Error {
  return Error(
