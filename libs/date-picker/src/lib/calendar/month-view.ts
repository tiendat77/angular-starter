...
export class MonthView<D> implements AfterContentInit, OnChanges, OnDestroy {
   ...
   */
  @Output() readonly dragEnded = new EventEmitter<CalendarUserEvent<DateRange<D> | null>>();

  /** Emits when any date is activated. */
  @Output() readonly activeDateChange: EventEmitter<D> = new EventEmitter<D>();

  /** The body of calendar table */
  @ViewChild(CalendarBody) _calendarBody: CalendarBody;
  ...
  _dateSelected(event: CalendarUserEvent<number>) {
   ...
   */
  _updateActiveDate(event: CalendarUserEvent<number>) {
   ...
   */
  protected _dragEnded(event: CalendarUserEvent<D | null>) {
