...
import { inject, ErrorHandler, DOCUMENT, SecurityContext, Injectable, Optional, SkipSelf, InjectionToken, ElementRef, HostAttributeToken, booleanAttribute, Input, ChangeDetectionStrategy, ViewEncapsulation, Component, NgModule, ENVIRONMENT_INITIALIZER } from '@angular/core';
...
class SvgIconRegistry {
    _httpClient = inject(HttpClient, { optional: true });
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconRegistry, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconRegistry, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconRegistry, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: () => [] });
/** @docs-private */
function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry) {
...
class SvgIcon {
    ...
    _iconRegistry = inject(SvgIconRegistry);
    _errorHandler = inject(ErrorHandler);
    _location = inject(SVG_ICON_LOCATION);
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIcon, decorators: [{
            ...
            args: [{ template: '<ng-content />', selector: 'svg-icon', exportAs: 'svgIcon', host: {
                    ...
                    }, encapsulation: ViewEncapsulation.None, changeDetection: ChangeDetectionStrategy.OnPush, styles: [".svg-icon{-webkit-user-select:none;user-select:none;background-repeat:no-repeat;display:inline-block;fill:currentColor;height:24px;width:24px;min-width:24px;min-height:24px;overflow:hidden}.svg-icon.svg-icon-inline{font-size:inherit;height:inherit;line-height:inherit;width:inherit}.svg-icon.svg-ligature-font[fontIcon]:before{content:attr(fontIcon)}[dir=rtl] .svg-icon-rtl-mirror{transform:scaleX(-1)}\n"] }]
 ...
 */
class SvgIconModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: SvgIconModule, imports: [SvgIcon], exports: [SvgIcon] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconModule });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SvgIconModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [SvgIcon],
                    exports: [SvgIcon],
...
class IconsService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: IconsService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: IconsService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: IconsService, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: () => [] });
