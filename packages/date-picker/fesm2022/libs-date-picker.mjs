...
class YearView {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [
      ...
      { token: DateAdapter, optional: true },
...
class DatepickerBase {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [
      ...
      { token: DATEPICKER_SCROLL_STRATEGY },
      { token: DateAdapter, optional: true },
      { token: i2.Directionality, optional: true },
      { token: DateSelectionModel },
    ],
...
class DatepickerInput extends DatepickerInputBase {
  ...
  static ɵdir = i0.ɵɵngDeclareDirective({
    ...
    inputs: {
      ...
      min: 'min',
      max: 'max',
      dateFilter: ['datepickerFilter', 'dateFilter'],
    },
    host: {
      listeners: {
...
class DatepickerModule {
  ...
  static ɵinj = i0.ɵɵngDeclareInjector({
    ...
    ngImport: i0,
    type: DatepickerModule,
    imports: [CalendarModule, DatepickerInputModule, CalendarModule, DatepickerInputModule],
  });
}
i0.ɵɵngDeclareClassMetadata({
  minVersion: '12.0.0',
...
export {
  ...
  LUXON_DATE_ADAPTER_OPTIONS_FACTORY,
  LUXON_DATE_FORMATS,
  LuxonDateAdapter,
  LuxonDateModule,
  MonthView,
  ...
  NativeDateAdapter,
  NativeDateModule,
  SINGLE_DATE_SELECTION_MODEL_FACTORY,
  SINGLE_DATE_SELECTION_MODEL_PROVIDER,
