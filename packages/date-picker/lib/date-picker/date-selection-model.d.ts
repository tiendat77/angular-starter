 ...
 * @docs-private
 */
export declare abstract class DateSelectionModel<S, D = ExtractDateTypeFromSelection<S>>
...
/** @docs-private */
export declare function SINGLE_DATE_SELECTION_MODEL_FACTORY(
  parent: SingleDateSelectionModel<unknown>,
  adapter: DateAdapter<unknown>
): SingleDateSelectionModel<unknown>;
/**
